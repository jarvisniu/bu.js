...
class DrawCircleDiameterReactor extends Bu.ReactorBase {
  constructor(bu) {
    super()
    this.bu = bu
    this.circle = null
  ...
  onMouseMove(ev) {
    ...
    if (
      ...
      this.circle.radius = this.mousePos.distanceTo(this.mousePosDown) / 2
      this.circle.center = this.line.midpoint
    }
  }
  onMouseUp() {
    this.isConfirmed =
...
Bu.DrawCircleDiameterReactor = DrawCircleDiameterReactor
